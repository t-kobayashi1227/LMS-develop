  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] p-8 text-center animate-in fade-in duration-300">
      ...
      <div className="flex items-center gap-4">
        ...
        <Link href="/admin/dashboard" className="px-6 py-3 border border-outline-variant/30 rounded-xl font-bold text-secondary hover:text-on-surface transition-colors">
          ダッシュボードに戻る
        </Link>
      </div>
    </div>

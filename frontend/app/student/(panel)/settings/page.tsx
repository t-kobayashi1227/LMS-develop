          ...
          <div className="p-5 md:p-6 space-y-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-secondary">受講者</p>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input id="display-name" type="text" defaultValue={user.name} className="w-full px-4 py-3 bg-surface-low border border-outline-variant/30 rounded-xl text-sm outline-none focus:border-primary transition-colors" />
              </div>
              <div>
                <label htmlFor="email" className="block text-xs font-bold text-secondary uppercase tracking-widest mb-2">メールアドレス</label>
                <input id="email" type="email" defaultValue="kenta.tanaka@example.com" className="w-full px-4 py-3 bg-surface-low border border-outline-variant/30 rounded-xl text-sm outline-none focus:border-primary transition-colors" />
              </div>
            </div>
          </div>
        </div>
